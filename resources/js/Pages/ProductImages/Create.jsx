...
export default function CreateProductImage({ products }) {
    ...
    const cardHeader = (
        <div className="flex items-center gap-4 p-4">
            ...
            <div>
                <h2 className="text-2xl font-bold text-gray-800 m-0">Upload Product Image</h2>
                <p className="text-gray-600 m-0 mt-1">Add a new image to your product</p>
            </div>
        </div>
    );
    ...
    return (
        <>
            <Head title="Upload Product Image" />
            <Toast ref={toast} />
                                            ...
                                            <Dropdown
                                                ...
                                                itemTemplate={(option) => (
                                                    <div className="flex align-items-center gap-2 p-2">
                                                        <i className="pi pi-box text-gray-500"></i>
                                                        <div>
                            ...
                            <Card className="shadow-3">
                                ...
                                <div className="space-y-2">
                                    <Button
                                        ...
                                        onClick={() => window.location.href = route('product-images.index')}
                                    />
                                    <Button

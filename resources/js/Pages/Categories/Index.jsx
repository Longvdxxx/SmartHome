...
export default function Index({ auth, categories, filters }) {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    router.get(route('categories.index'), { search: globalFilter }, {
      preserveState: true,
      replace: true
    });
  };
  ...
  const actionTemplate = (rowData) => (
    <div className="flex gap-2">
      <Button
        ...
        onClick={() => router.visit(route('categories.edit', rowData.id))}
      />
      <Button
        icon="pi pi-trash"
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <Card className="text-center shadow-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{categories.total}</span>
            ...
            <Card className="text-center shadow-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{categories.current_page}</span>
            ...
            <Card className="text-center shadow-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{categories.last_page}</span>

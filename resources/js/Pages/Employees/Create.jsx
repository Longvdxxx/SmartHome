...
export default function CreateEmployee({ stores = [] }) {
    ...
    const cardHeader = (
        <div className="flex items-center gap-4 p-4">
            ...
            <div>
                <h2 className="text-2xl font-bold text-gray-800 m-0">Create New Employee</h2>
                <p className="text-gray-600 m-0 mt-1">Add a new employee to the system</p>
            </div>
        </div>
    );
                                ...
                                <form onSubmit={submit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                            ...
                                            <div className="field">
                                                <label htmlFor="store_id" className="block text-900 font-medium mb-2">
                                                    Store
                                                </label>
                                                <Dropdown
                                                    id="store_id"
                                                ...
                                                />
                                                {errors.store_id && (
                                                    <small className="p-error block mt-1">{errors.store_id}</small>
                                                )}
                                            </div>
                                        </div>
                                    </div>

...
export default function Index({ auth, users, filters }) {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    router.get(route('users.index'), { search: globalFilter }, {
      preserveState: true,
      replace: true
    });
  };
  ...
  const actionTemplate = (rowData) => (
    <div className="flex gap-2">
      <Button
        ...
        onClick={() => router.visit(route('users.edit', rowData.id))}
      />
      <Button
        icon="pi pi-trash"
  ...
  const phoneTemplate = (rowData) => rowData.phone_number || <span className="text-gray-400">-</span>;
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <Card className="text-center shadow-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{users.total}</span>
            ...
            <Card className="text-center shadow-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{users.current_page}</span>
            ...
            <Card className="text-center shadow-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{users.last_page}</span>
